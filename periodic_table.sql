...
--
-- Name: elements element_uniq_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT element_uniq_name UNIQUE (name);


--
-- Name: elements element_uniq_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT element_uniq_symbol UNIQUE (symbol);
...
--
-- Name: properties fk_prop_type; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_prop_type FOREIGN KEY (type_id) REFERENCES public.types(type_id);
